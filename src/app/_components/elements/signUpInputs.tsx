    ...
    return (
        <div className={styles.container}>
            ...
            <PasswordInput
                ...
                description={"Password must contain atleast one uppercase letter, one lowercase letter, and one special character"} placeholder={"Enter your password..."}
                onChange={(event) => {
            ...
            <PasswordInput
                ...
                onChange={(event) => {
                    dispatch({ name: "password_confirmation", payload: event.target.value })
